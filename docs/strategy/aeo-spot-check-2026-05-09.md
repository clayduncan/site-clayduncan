...
| Team Duncan                              | Results were mixed with other Duncan / mortgage entities.                                                                               |                             Partial | The entity is new and needs repeated off-site and on-site reinforcement.                             | Keep header, schema, llms.txt, and homepage FAQ wording consistent.                                                                            |
